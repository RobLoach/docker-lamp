...
# PHP
RUN apt-get install -y libapache2-mod-php5 php5 php5-json php5-cli php5-curl php5-mcrypt php5-xdebug mcrypt libmcrypt-dev
...
RUN (echo 'phpmyadmin phpmyadmin/app-password password' | debconf-set-selections)
